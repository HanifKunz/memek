//-----(Hanif Bot by Hanif Bot Inc.)-----\\
//-----(Youtube Channel: Hanif)-----\\
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*Hanif Bot*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/G3a3AQndqS5J45eD7zznXF', "groupName": `Hanif Bot Inc.`, "footerText": "*Hanif Bot*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = "Hanif Bot"; break;
                case 1: jamss = "Hanif Bot"; break;
                case 2: jamss = "Hanif Bot"; break;
                case 3: jamss = "Hanif Bot"; break;
                case 4: jamss = "Hanif Bot"; break;
                case 5: jamss = "Hanif Bot"; break;
                case 6: jamss = "Hanif Bot"; break;
                case 7: jamss = "Hanif Bot"; break;
                case 8: jamss = "Hanif Bot"; break;
                case 9: jamss = "Hanif Bot"; break;
                case 10: jamss = "Hanif Bot"; break;
                case 11: jamss = "Hanif Bot"; break;
                case 12: jamss = "Hanif Bot"; break;
                case 13: jamss = "Hanif Bot"; break;
                case 14: jamss = "Hanif Bot"; break;
                case 15: jamss = "Hanif Bot"; break;
                case 16: jamss = "Hanif Bot"; break;
                case 17: jamss = "Hanif Bot"; break;
                case 18: jamss = "Hanif Bot"; break;
                case 19: jamss = "Hanif Bot"; break;
                case 20: jamss = "Hanif Bot"; break;
                case 21: jamss = "Hanif Bot"; break;
                case 22: jamss = "Hanif Bot"; break;
                case 23: jamss = "Hanif Bot"; break;
            }
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hi ${pushname}, Sorry it seems at this time ${NamaOwner} is offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minute, ${heheh.seconds} Second\n\nPlease contact again after Online`, "*Hanif Bot*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Hanif Bot`,body:"HORNY = BONK",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/916909137213`}}})
		}
		const simir = (teks) => {
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*Hanif Bot*", [{buttonId: 'igm', buttonText: {displayText: 'Github'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('https://github.com/HanifKunz')
}
if(isButton == 'ytm'){
reply('https://youtube.com/channel/UChK0C2s6vwo5V1w528jrWkg')
}
...
ini_list.push({
"displayName": `Hanif Bot Developer`,
...
──────────────────
*👇SCRIPT GITHUB LINK👇*
https://github.com/HanifKunz/DogeBot2
_BASE : Hanif Bot Inc._
_ORI SCRIPT : Hanif Bot Version 2_
_OWNER : ${NamaOwner}_
⍟ ────────────────── ⍟`
buttons = [
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Hanif Bot Script`,
          "url": "https://github.com/HanifKunz/DogeBot2"
        },
        "index": 0
      }
    ]
...
const btnbc = {
    ...
    footerText: '*_Hanif Bot BROADCAST_*',
    buttons: buttons,
    headerType: 1
}
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('The text?')
                    teks = body.slice(12)
                    alpha.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`Hanif Bot`}, MessageType.location)
          ...
          reply('reply sticker/audio')
           ...
           case 'slanderpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY Hanif Bot`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `Hanif Bot`, MessageType.extendedText,{
 quoted: {
key: {
...
alpha.sendMessage(from, `Hanif Bot`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
